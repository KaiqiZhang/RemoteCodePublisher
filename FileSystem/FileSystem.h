 ...
 * ====================
 * ver 2.7 : 07 Apr 17
 * - added get relative & absolute path functions
 * ver 2.6 : 04 Apr 15
...
namespace FileSystem
{
  ...
  public:
    ...
    static std::string getRelativeFromPathToFile(const std::string& pathFrom, const std::string& fileTo);
    static std::string getRelativeFromFileToFile(const std::string& fileFrom, const std::string& fileTo);
    static std::string getAbsoluteFileSpec(const std::string& fileSpec, const std::string& path);
